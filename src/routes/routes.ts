...
const models: TsoaRoute.Models = {
    ...
    "Omit_IMenuItem.orden_": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_IMenuItem.Exclude_keyofIMenuItem.orden__","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "IJsonMenu": {
        "dataType": "refObject",
        "properties": {
            ...
            "items": {"dataType":"array","array":{"dataType":"refAlias","ref":"Omit_IMenuItem.orden_"},"required":true},
        },
    ...
    "Omit_IUserRepository.password_": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_IUserRepository.Exclude_keyofIUserRepository.password__","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
};
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/api/obras/backoffice/general/v1/alltipoobras',
            ...
            function BackofficeGeneralController_findAllTipoObra(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.findAllTipoObra.apply(controller, validatedArgs as any);
        ...
        app.post('/api/auth/v1/signin',
            ...
            const args = {
                    credencialesUsuario: {"in":"body","name":"credencialesUsuario","required":true,"ref":"ISignInInput"},
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/api/auth/v1/consultatest',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.consultaTest)),

            function AuthController_consultaTest(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
            };
